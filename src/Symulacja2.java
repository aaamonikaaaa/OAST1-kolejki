...
public class Symulacja2 {
    ...
    private double czasSymulacji2 = 100;
    private double aktualnyCzas;
    private ZapisywanieWynikow2 zapisywanieWynikow2;
    ...
    public Zdarzenia rozpocznijZdarzenia2 (double lambda, boolean onOff){
        if(lambda>0) {
            ...
            if (czasSymulacji2 > serwer.getSredniCzasWlaczonego() && onOff)
    ...
    public Symulacja2(double lambda){
        sredniCzasObslugi = 0.125;
        aktualnyCzas = 0;
        serwer = new Serwer();
        //zdarzenia = rozpocznijZdarzenia2(lambda, true);
        zdarzenia = rozpocznijZdarzenia2(lambda, false);
        System.out.println("Symulacja2 zaczeta");
    }


    public void rozpocznijSymulacje2(){
        while(!zdarzenia.getZdarzeniaPrzychodzace().isEmpty()){
            obluzZdarzenie(zdarzenia.get());
        }
        zapisywanieWynikow2 = new ZapisywanieWynikow2();
        zapisywanieWynikow2.zapisywanieWynikowDoPliku2(zdarzenia.getZdarzeniaWychodzace());
    }
