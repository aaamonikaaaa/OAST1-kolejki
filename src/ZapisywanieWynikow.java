 ...
 */
public class ZapisywanieWynikow {
    public void zapisywanieWynikowDoPliku(LinkedList<Zdarzenia> listaZdarzen) {
       ...
       // System.out.println("Srednie opoznienie:\t" + srednieOpoznienie + "\n" + czasObslugi.toString());
        ...
        private void zapiszDoPliku (String nazwa, String zapisz){
